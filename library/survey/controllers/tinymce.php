<?php
class sv46v_tinymce extends wv46v_action {
	...
	function mce_external_pluginsWPfilter($plugin_array) {
		$plugin_array ['v46v_tinymce'] = $this->application ()->pluginuri () . '/library/base/public/js/tinymce_register.js';
		return $plugin_array;
	}
	public function v46v_dataWPfilter($data)
	{
